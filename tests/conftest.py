...
# Чтобы было удобно работать с данными, создаем дополнительный слой UserFixture, который объединяет запрос и ответ
class UserFixture(BaseModel):
    ...
    def authentication_user(self) -> AuthenticationUserSchema:
        """Формирует модель AuthenticationUserSchema для аутентификации API-клиентов."""
...
def private_users_client(function_user: UserFixture) -> PrivateUsersClient:
    """Возвращает инициализированный клиент PrivateUsersClient с данными аутентификации."""
